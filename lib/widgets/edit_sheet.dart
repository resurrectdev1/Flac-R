...
class _EditSheetState extends State<EditSheet> {
  ...
  Future<void> _save() async {
    ...
    final resolvedTrack = trackRaw.isNotEmpty
        ? int.tryParse(trackRaw)
        : f.trackNumber;
    final resolvedDisc = discRaw.isNotEmpty
        ? int.tryParse(discRaw)
        : f.discNumber;
    ...
    try {
      ...
      final updated = f.copyWith(
        ...
        lyrics: lyrics.isNotEmpty ? lyrics : null,
        discNumber: resolvedDisc,
        composer: composerChanged && composerVal.isNotEmpty
            ? composerVal
            : null,
